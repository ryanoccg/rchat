...
class WorkflowController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'trigger_type' => 'required|in:customer_created,customer_returning,first_message,conversation_created,conversation_closed,message_received,no_response,scheduled',
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'description' => 'nullable|string|max:1000',
            'status' => 'in:draft,inactive,active',
            'trigger_type' => 'sometimes|required|in:customer_created,customer_returning,first_message,conversation_created,conversation_closed,message_received,no_response,scheduled',
            'trigger_config' => 'nullable|array',
            'execution_mode' => 'in:sequential,parallel,mixed',
            'workflow_definition' => 'nullable|array',
        ]);
